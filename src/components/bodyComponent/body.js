    ...
    return(
        <div style={{backgroundColor:"grey"}}>
            ...
            <div className={styles.currentCondContainer}>
                <div className={styles.currentCondDiv}><div className={styles.iconDiv}><i class="bi bi-wind"></i></div><div>Wind <br></br>{data.current.wind_speed_10m} {data.current.wind_direction_10m}</div></div> 
            ...
            <div className={styles.currentCondDiv}><div className={styles.iconDiv}><i class="bi bi-sunrise-fill"></i></div> {data.daily.sunrise[0].slice(-5)}</div><div className={styles.currentCondDiv}><div className={styles.iconDiv}><i class="bi bi-sunset-fill"></i></div>{data.daily.sunset[0].slice(-5)}</div>
            </div>
        </div>
    )
